...
// constexpr static auto kNtupleDaosURI{"daos://009d0c2c-76ab-4af2-91b1-da92bb6ca060:1/76e011cc-8137-43ea-b715-98080620f2c1"};
constexpr static auto kNtupleDaosCache{"daos://a263c4e6-8ed0-401a-8105-3d822d5e34bf:1/c004a617-cd88-46c7-9ead-38d464856fcc"};
...
void ntpl004_dimuon_cache() {
   ...
   opts.fCachePath = kNtupleDaosCache;

//   auto df = ROOT::Experimental::MakeNTupleDataFrame("Events", kNtupleDaosCache, opts);
   auto df = ROOT::Experimental::MakeNTupleDataFrame("Events", kNTupleFileName, opts);
