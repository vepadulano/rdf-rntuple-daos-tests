...
parser.add_argument("cpulist", help="Range of assigned cpus.")
...
def analysis(ntuplename, ntuplepath, procid):
    ...
    print(f"Process {procid} on cpu list {args.cpulist} has affinity {r.stdout.decode()}")
    myinit()
    ...
    with open(f"multiproc_lhcb_process{procid}_{args.cpulist}.txt", "a+") as f:
...
if __name__ == "__main__":
    ...
    outcsv = f"multiproc_lhcb_100x_{nchunks}cores_{args.cpulist}.csv"
