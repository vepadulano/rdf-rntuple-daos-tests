...
def write_histo_to_file(h):
    outfile = ROOT.TFile("lhcb_histo_200x.root", "RECREATE")
    outfile.WriteObject(h, "B_mass_200x")
...
if __name__ == "__main__":
    ...
    sconf = pyspark.SparkConf().setAll([("spark.master", "spark://hl-d104.head.cm.us.cray.com:7077"),
    ...
    outcsv = f"distrdf_lhcb_200x_singlenodehl-d101_{args.storagetype}_{args.cores}cores.csv"
